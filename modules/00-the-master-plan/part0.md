...
│ • Routing & NAT   │ │ • Databases       │ │ • FS internals    │
│ • DHCP & NTP      │ │ • Docker/Podman   │ │ • Memory mgmt     │
│ • Network bonding  │ │ • Monitoring      │ │ • eBPF/tracing    │
│ • VPN & tunneling  │ │ • CI/CD basics   │ │ • Namespaces      │
│ • Packet analysis  │ │ • Git & deploy   │ │ • PAM/auth        │
└───────────────────┘ └───────────────────┘ └───────────────────┘
```
...
| 58 | Secrets Management — Vault, SOPS, Sealed Secrets | Advanced |
| 59 | High Availability and Clustering | Advanced |
| 60 | Disaster Recovery Planning | Advanced |
| 61 | Filesystem Internals — Inodes, Journaling, and Recovery | Advanced |
| 62 | Memory Management — Swap, Page Cache, NUMA | Advanced |
| 63 | eBPF & Modern Tracing — Observing the Invisible | Advanced |
| 64 | Linux Namespaces — The Building Blocks of Containers | Advanced |
| 65 | PAM & Centralized Authentication — SSSD, LDAP, and authselect | Advanced |

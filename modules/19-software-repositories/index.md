...
**Prerequisites:** Complete [Part 18 - environment-variables](../18-environment-variables/) before this module.
## Sections

- [What You Will Achieve In](01-what-you-will-achieve-in.md)
- [Level 1 Basic Repository Architecture](02-level-1-basic-repository-architecture.md)
- [Section 1 Repository Architecture](03-section-1-repository-architecture.md)
- [Section 2 Debianubuntu Repositories Sourceslist](04-section-2-debianubuntu-repositories-sourceslist.md)
- [Level 2 Intermediary Ppas Rpm](05-level-2-intermediary-ppas-rpm.md)
- [Section 3 Ppas Personal Package](06-section-3-ppas-personal-package.md)
- [Section 4 Rpm Repositories Fedorarhel](07-section-4-rpm-repositories-fedorarhel.md)
- [Section 5 Epel Extra Packages](08-section-5-epel-extra-packages.md)
